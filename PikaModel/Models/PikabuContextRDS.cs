...
{
    public partial class PikabuContextRDS : DbContext
    {
        public PikabuContextRDS()
        {
        }

        public PikabuContextRDS(DbContextOptions<PikabuContext> options)
            : base(options)
        {
        }
        ...
        {
            return "Server=pikabu.c2v0z0gw7ckj.us-east-2.rds.amazonaws.com;Port=3306;Database=pikabu;Uid=pikabu;Pwd=]nS`VCS{v}Bau9>#";
        }
